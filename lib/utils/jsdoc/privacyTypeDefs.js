 ...
 * This does not imply that an existing consent is positive if requiresConsent
 * is set to false.
 * @property {AssessmentDecision} result The result object that contains the
 * decision.
 */
 ...
 * @property {number} startTime The time since Epoch that indicates when the
 * consent becomes active.
 * @property {number} endTime The time since Epoch that indicates when the
 * consent elapses.
 ...
 * <code>{ "key": "somekey", "value": "somevalue" }</code>
 */
 ...
 * to the user.
 * @property {boolean} termsOfUseRef The terms of use if this record references
 * a EULA.
