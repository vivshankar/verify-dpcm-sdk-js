 ...
 * @property {boolean} showPurpose Indicates if the purpose of use should be shown
 * @property {boolean} isTransparent Indicates if the user should be allowed to decline consent
 * and still be allowed to continue.
 * @property {boolean} isOptInOrOut Indicates that the type of consent to be collected is 
 * opt-in/out vs allow/deny. This doesn't apply if isTransparent is set to true.
