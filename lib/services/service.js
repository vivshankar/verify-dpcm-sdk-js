...
class Service {
    ...
    * @param {string} [auth.accessToken] The access token to authorize the request.
    ...
    */
    constructor(auth, baseURL, context, contentTypeHeader = 'json',
        ...
        this._context.subjectId = (this._context.subjectId && this._context.subjectId != '') ? this._context.subjectId : null;
        this._context.isExternalSubject = (this._context.isExternalSubject) ? this._context.isExternalSubject : false;
        this._context.ipAddress = (this._context.ipAddress && this._context.ipAddress != '') ? this._context.ipAddress : null;
    ...
    */
     async patch(path, data = {}, params = {}) {
        ...
        console.log(`[${Service.name}:patch(path, data={}, params={})]`,
            'path:', path);
        console.log(`[${Service.name}:patch(path, data={}, params={})]`,
            'data:', dataMasked);
        console.log(`[${Service.name}:patch(path, data={}, params={})]`,
