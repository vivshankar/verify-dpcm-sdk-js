...
class Privacy {
  ...
  async assess(items) {
    ...
    try {
      let assessment = await service.requestApproval(items);
      ...
      for (let ia of assessment) {
        ...
        if (ia.result[0].approved) {
          ...
          if (// User has already opted out or denied consent.
              // Rule decision is deny.
              // The input application {{appID}} to purpose mapping {{purpose}} is not valid.
              !['CSIBT0040I', 'CSIBT0041I', 'CSIBT0060I', 'CSIBT0016E']
